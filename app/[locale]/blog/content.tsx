...
const content = {
  ...
  ar: {
    ...
    body: 'سننشر المقالات هنا بمجرد اكتمالها ومراجعتها — حول مواضيع مثل كيفية عمل جوازات السفر الإلكترونية، وتصميم تجربة إعداد رقمية عربية أولاً، والتكامل مع التحقق من الهوية عبر API وWebhooks. لا يوجد شيء منشور بعد، لذا ليس لدينا ما نعرضه لك سوى هذه الملاحظة.',
    cta: 'تواصل مع فريقنا',
  },
};
