...
const whyUsItems = {
  en: [
    {
      ...
      desc: 'You will work on technology that helps people prove their identity online — with real consequences for security, privacy, and financial inclusion in Syria and beyond.',
      icon: (
  ...
  ar: [
    {
      title: 'عمل ذو معنى',
      desc: 'ستعمل على تقنية تساعد الأشخاص على إثبات هويتهم عبر الإنترنت — بتأثيرات حقيقية على الأمن والخصوصية والشمول المالي في سوريا وخارجها.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.7} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
        </svg>
  ...
  en: [
    {
      ...
      type: 'Full-time',
      desc: 'Own the core API infrastructure that powers identity verification. You will architect and build the services handling ePassport verification requests, working closely with our product and compliance teams.',
