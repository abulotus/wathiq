...
const content = {
  ...
  ar: {
    ...
    body: 'ننشر فقط دراسات الحالات التي تستند إلى مشاريع حقيقية وموثقة، وتحظى بموافقة العميل على مشاركة نتائجها. لا توجد لدينا دراسات حالة منشورة بعد — تابعنا قريباً، أو تواصل معنا لمناقشة مرجع مناسب لحالة استخدامك.',
    cta: 'تواصل مع فريقنا',
  },
};
