          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection delay={0.2} direction="left">
              ...
              <div className="grid grid-cols-2 gap-5">
                {[
                  { val: '140', label: isRTL ? 'جواز سفر إلكتروني مدعوم' : 'Supported ePassports', color: 'bg-electric-50 border-electric-100' },
                  { val: 'AR', label: isRTL ? 'واجهة عربية أولاً' : 'Arabic-First Interface', color: 'bg-teal-50 border-teal-100' },
                  { val: 'API', label: isRTL ? 'وWebhooks' : 'API & Webhooks', color: 'bg-indigo-50 border-indigo-100' },
                  { val: '2', label: isRTL ? 'لوحة تحكم وتطبيق جوال' : 'Client Dashboard & Mobile App', color: 'bg-amber-50 border-amber-100' },
                ].map((s, i) => (
