    ...
    <div className="min-h-screen bg-navy-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href={href('/')} className="btn-outline-white px-8 py-3 justify-center">
            {isRTL ? 'العودة للرئيسية' : 'Back to Home'}
          </Link>
        </div>

        <div className="mt-12 pt-12 border-t border-white/10">
          <p className="text-slate-400 text-sm mb-4">{isRTL ? 'تحتاج مساعدة؟' : 'Need help?'}</p>
          <Link href={href('/contact')} className="text-electric-400 hover:text-electric-300 transition-colors">
