    ...
    <div className="min-h-screen bg-navy-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <Link href={href('/contact')} className="btn-outline-white px-8 py-3 justify-center">
        ...
        <div className="grid sm:grid-cols-3 gap-6 mt-16 pt-12 border-t border-white/10">
          <Link href={href('/platform')} className="group">
            <div className="text-slate-400 group-hover:text-electric-400 transition-colors mb-2">{isRTL ? 'المنصة' : 'Platform'}</div>
            <div className="text-slate-500 text-sm group-hover:text-slate-300 transition-colors">/platform</div>
          </Link>
          <Link href={href('/contact')} className="group">
            <div className="text-slate-400 group-hover:text-electric-400 transition-colors mb-2">{isRTL ? 'تواصل معنا' : 'Contact'}</div>
          ...
          <Link href={href('/security')} className="group">
            <div className="text-slate-400 group-hover:text-electric-400 transition-colors mb-2">{isRTL ? 'الأمان' : 'Security'}</div>
