  ...
  ar: {
    ...
    body: (
      <>
        ...
        <p>
          بوصفنا شركة مقرها المملكة المتحدة تخدم بشكل رئيسي العملاء في الشرق الأوسط وشمال أفريقيا، قد تُنقل بعض بياناتك الشخصية إلى دول خارج المملكة المتحدة أو المنطقة الاقتصادية الأوروبية. وعند حدوث عمليات النقل هذه، نضمن وجود ضمانات مناسبة — مثل اتفاقيات نقل البيانات الدولية في المملكة المتحدة (IDTAs) — لتوفير مستوى كافٍ من الحماية.
        </p>
