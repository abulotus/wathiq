  ...
  ar: {
    ...
    body: (
      <>
        ...
        <p>
          اسم واثق وشعاره وجميع العلامات المرتبطة به هي علامات تجارية لواثق ديجيتال المحدودة. لا يمنحك أي شيء في هذه الشروط أي حق في استخدام علاماتنا التجارية دون إذن كتابي مسبق.
        </p>
