...
const content = {
  ...
  ar: {
    ...
    body: (
      <>
        <p>
          تحكم شروط الخدمة هذه ("<strong>الشروط</strong>") وصولك إلى موقع <a href="https://www.wathiq-sy.com">www.wathiq-sy.com</a> واستخدامه وأي خدمات ذات صلة تقدمها شركة ثقة انتلجنس ليمتيد ("<strong>ثقة انتلجنس</strong>"، "<strong>نحن</strong>"، "<strong>لنا</strong>"، أو "<strong>خاصتنا</strong>")، المسجلة في إنجلترا وويلز، رقم الشركة: 12576917، العنوان المسجل: 71-75 شيلتون ستريت، لندن، جريتر لندن، المملكة المتحدة، WC2H 9JQ.
        </p>
        ...
        <p>
          اسم واثق وثقة انتلجنس وشعاراتهم وجميع العلامات المرتبطة بهم هي علامات تجارية لشركة ثقة انتلجنس ليمتيد. ولا تمنحك هذه الشروط أي حق في استخدام علاماتنا التجارية دون إذن كتابي مسبق.
        </p>
