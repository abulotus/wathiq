...
const faqs = {
  ...
  ar: [
    ...
    {
      q: 'هل يقدّم واثق خدمة فحص مكافحة غسل الأموال؟',
      a: 'نعم. يتوفر فحص مكافحة غسل الأموال للبنوك وشركات التقنية المالية كإضافة إلى خدمة التحقق من جواز السفر الإلكتروني. وتختار المؤسسة مصادر العقوبات وقوائم الأشخاص المعرّضين سياسياً التي تتوافق مع سياسة الامتثال لديها.',
    },
    {
      q: 'هل فحص مكافحة غسل الأموال تلقائي أم يدوي؟',
    ...
    {
      q: 'ماذا يحدث عند ظهور تطابق محتمل؟',
      a: 'يفتح التشابه المحتمل حالة تحقيق للامتثال مزودة بأدلة تفصيلية لكل مصدر ودرجة تشابه — دون رفض العميل تلقائياً. يراجع فريقك الحالة ويغلقها كمطابقة إيجابية زائفة، أو تطابق مؤكد، أو بحاجة لمزيد من المعلومات.',
    },
    {
