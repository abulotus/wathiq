  ...
  return (
    <section className="section-pad bg-white">
      <div className="container-wide">
        <AnimatedSection>
          <div className="relative rounded-3xl bg-navy-900 overflow-hidden px-5 py-14 sm:px-14 sm:py-16 text-center">
            ...
            <div className="relative z-10">
              <h2 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 max-w-2xl mx-auto">
                {isRTL
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <Link href={href('/contact')} className="btn-outline-white px-8 py-3.5">
