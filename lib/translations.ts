  ...
  ar: {
      ...
      items: [
        {
          ...
          desc: 'مساعدة المؤسسات المالية على بناء تجارب رقمية موثوقة، بما يشمل فحص العقوبات وقوائم الأشخاص المعرّضين سياسياً لدعم متطلبات مكافحة غسل الأموال.',
    ...
    contact: {
      ...
      info: {
        ...
        phone_syria: { label: 'الهاتف (سوريا)', value: '+963 996 380110' },
